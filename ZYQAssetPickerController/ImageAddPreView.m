...
- (void)initResource
{
    ...
    self.backgroundColor = COLOR_MAIN_TEXT;
    ...
    [_selectBeforeLab setTextAlignment:0];
    ...
    _selectNumLab = [[UILabel alloc] initWithFrame:CGRectMake(2*D_Pending_Width,
                                                                ...
                                                                self.bounds.size.width - 100,
                                                                20)];
    [_selectNumLab setTextColor:COLOR_MAIN_GREEN];
    [_selectNumLab setTextAlignment:1];
    ...
    [_selectafterLab setTextAlignment:2];
    ...
    _startPintuButton =  [[UIButton alloc] initWithFrame:CGRectMake(self.bounds.size.width - 108/2.0f-D_Pending_Width,
                                                                    ...
                                                                    108/2.0f,
                                                                    56/2.0f)];
    [_startPintuButton setBackgroundColorNormal:COLOR_MAIN_GREEN highlightedColor:COLOR_MAIN_GREEN];
...
//    [self resetContentView];
    if (_delegateSelectImage && [_delegateSelectImage respondsToSelector:@selector(deletePintuALAsset:)]) {
        [_delegateSelectImage deletePintuALAsset:imageEditView.asset];
    }
}
